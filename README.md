...
- `gdcm:stats`, `gdcm:transcode-rle`
- `dcmtk:jpeg-lossless`, `dcmtk:raw-dump`, `dcmtk:dicomdir`, `dcmtk:metadata`
- `itk:histogram`, `itk:median`, `itk:nrrd`, `itk:slice`
- `vtk:mask`, `vtk:metadata`, `vtk:isosurface`, `vtk:nifti`, `vtk:stats`
